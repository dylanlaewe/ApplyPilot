...
const INTENT_PATTERNS: IntentPattern[] = [
  ...
  { intent: "resume_upload", patterns: [/resume/, /\bcv\b/], allowedTypes: ["file", "search"] },
  { intent: "cover_letter_upload", patterns: [/cover letter/], allowedTypes: ["file", "search"] },
  {
  ...
  { intent: "education_degree", patterns: [/\bdegree\b/, /degree type/, /highest degree/], allowedTypes: ["text", "select-one", "search"] },
