...
export const FIELD_INTENT_PATTERNS: Array<{
  ...
  { intent: "resume_upload", patterns: [/resume/, /\bcv\b/, /upload resume/], allowedTypes: ["file"] },
  { intent: "cover_letter_upload", patterns: [/cover letter/, /upload cover letter/], allowedTypes: ["file"] },
  ...
  { intent: "education_degree", patterns: [/\bdegree\b/], allowedTypes: ["text", "select-one"] },
